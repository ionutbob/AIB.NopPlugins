...
{
    public class RequestsLogsObjectContext : DbContext, IDbContext
    {
        public RequestsLogsObjectContext(DbContextOptions<RequestsLogsObjectContext> options) : base(options)
        {
        }

        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.ApplyConfiguration(new RequestLogRecordMap());
        ...
        {
            //drop the table
            this.DropPluginTable(nameof(RequestLogRecord));
        }
    }
}
