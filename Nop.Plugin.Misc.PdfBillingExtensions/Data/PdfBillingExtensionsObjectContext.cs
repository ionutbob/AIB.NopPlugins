...
{
    public class PdfBillingExtensionsObjectContext : DbContext, IDbContext
    {

        public PdfBillingExtensionsObjectContext(DbContextOptions<PdfBillingExtensionsObjectContext> options) : base(options)
        {
        }

        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.ApplyConfiguration(new PdfBillRecordMap());
        ...
        {
            //drop the table
            this.DropPluginTable(nameof(PdfBillRecord));
        }
    }
}
