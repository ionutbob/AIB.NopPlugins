...
namespace Nop.Plugin.Payments.CashOnDelivery
{
    ...
    public class CashOnDeliveryPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public bool HidePaymentMethod(IList<ShoppingCartItem> cart)
        {
            ...
            if (_cashOnDeliveryPaymentSettings.ShippableProductRequired && !_shoppingCartService.ShoppingCartRequiresShipping(cart))
                return true;
        ...
        public override void Install()
        {
            ...
            {
                DescriptionText = "<p>You will pay on delivery</p><p>P.S. You can edit this text from admin panel.</p>"
            };
            ...
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Payment.CashOnDelivery.PaymentMethodDescription", "You will pay on delivery.");
